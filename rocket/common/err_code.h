#ifndef ROCKET_COMMON_ERR_CODE_H
#define ROCKET_COMMON_ERR_CODE_H
...
const int ERROR_FAILED_ENCODE = SYS_ERROR_PREFIX(0005); // encode失败
const int ERROR_FAILED_DECODE = SYS_ERROR_PREFIX(0006); //decode失败
